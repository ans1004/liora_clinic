...
<body>
    ...
    <!-- Content Section -->
    <section class="our-doctors-content">
        <div class="our-doctors-content-wrapper">
            <!-- #1 Doctor Profile -->
            <div class="our-doctors-section" id="1_doctor-profile">
                <!-- Profile 1: 홍지욱 대표원장 -->
                <div class="our-doctors-profile">
                    <div class="our-doctors-profile-image">
                        <img src="public/images/OurDoctors/image.png" alt="홍지욱 대표원장">
                    </div>
                ...
                <div class="our-doctors-profile our-doctors-profile-reverse">
                    ...
                    <div class="our-doctors-profile-text-block">
                        ...
                        <div class="our-doctors-profile-career">
                            ...
                            <ul class="our-doctors-profile-list">
                                <li class="liora-body-3-light">노바스킨 레이저연구학회 회원</li>
                                <li class="liora-body-3-light">아테나 리프팅연구회 회원</li>
                                <li class="liora-body-3-light">루미에르 의사 면허협회 정회원</li>
                                <li class="liora-body-3-light">前 미라벨 피부과 의원 대표원장</li>
                                <li class="liora-body-3-light">前 클라라스킨케어 클리닉 원장</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="our-doctors-profile">
                    <div class="our-doctors-profile-image">
                        <img src="public/images/OurDoctors/image3.png" alt="윤서린 원장">
                    </div>
                    <div class="our-doctors-profile-text-block">
                        <div class="our-doctors-profile-intro">
                            <div class="our-doctors-profile-name-wrapper">
                        ...
                        <div class="our-doctors-profile-specialty">
                            <h3 class="our-doctors-profile-label liora-title-2">Specialty</h3>
                            <ul class="our-doctors-profile-list">
                                <li class="liora-body-3-light">쁘디/스킨케어</li>
                                <li class="liora-body-3-light">여드름자국·흉터</li>
                                <li class="liora-body-3-light">목주름</li>
                            </ul>
                        </div>
                        <div class="our-doctors-profile-career">
                            <h3 class="our-doctors-profile-label liora-title-2">Career</h3>
                            <ul class="our-doctors-profile-list">
                                ...
                                <li class="liora-body-3-light">前 루시아 메디컬 센터 원장</li>
                                <li class="liora-body-3-light">前 아르떼 클리닉 진료과장</li>
                            </ul>
                        </div>
                    </div>
                </div>
